...
Classifique tipoResposta="social" somente quando a mensagem atual puder ser respondida sem comunicar fato: cortesia, agradecimento, confirmação simples ou encerramento sem pergunta nem solicitação. Se houver qualquer pergunta, solicitação ou conteúdo factual relevante a responder, inclusive depois de uma cortesia, use tipoResposta="factual". Em resposta social, protocolosAplicaveis, evidencias, obrigacoesResposta e informacoesFaltantes devem ser listas vazias; o histórico comercial não cria necessidade factual por si só.
...
Quando decisao.tipoResposta="social", responda somente à interação social atual, sem introduzir fato, condição ou oferta comercial; use protocolosUsados=[], obrigacoesCobertas=[] e afirmacoes=[].
