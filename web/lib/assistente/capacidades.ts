...
export const CATALOGO_CAPACIDADES_ASSISTENTE: readonly DefinicaoCapacidadeAssistente[] = [
  {
    ...
    limitacoes: [
      "Os dados atuais são sempre reconsultados na sua própria carteira.",
      "O histórico do imóvel não mostra o estado das mensagens programadas nem a próxima verificação de disponibilidade; isso vem de Mensagens e conversas e de Agenda.",
    ],
  ...
  },
  {
    id: "consultar_agenda",
    nome: "Agenda",
    descricao: "Consulta compromissos por período, situação ou imóvel, inclusive os lembretes de verificação de disponibilidade.",
    categoria: "consultar",
    tipo: "consulta",
    controle: "Somente consulta",
    exemplos: ["Quais são os compromissos de hoje?", "Quando será a próxima verificação do LD-201?"],
    limitacoes: ["Compromissos e mensagens programadas são consultados separadamente."],
    ferramentas: ["buscar_agenda"],
    termosDescoberta: ["consultar agenda", "ver agenda", "compromissos", "próximo compromisso", "agenda de hoje", "próxima verificação", "verificação de disponibilidade", "próximo lembrete", "lembrete de verificação"],
  ...
  },
  {
    ...
    descricao: "Consulta mensagens programadas, de um período ou de um imóvel, explica o que aconteceu com cada uma (enviada, cancelada, reprogramada, incluída em outra) e identifica conversas respondidas.",
    categoria: "consultar",
    tipo: "consulta",
    controle: "Somente consulta",
    exemplos: ["Quais proprietários responderam e aguardam meu retorno?", "Qual é a próxima mensagem programada?", "O que aconteceu com as mensagens agendadas do LD-201?"],
    ...
    // Singular e plural são termos distintos para a descoberta ("mensagem"
    // não é prefixo de "mensagens").
    termosDescoberta: [
      "consultar mensagens", "ver mensagens", "quem respondeu", "conversas",
      "mensagem agendada", "mensagens agendadas", "mensagem programada", "mensagens programadas",
      "o que aconteceu com a mensagem", "o que aconteceu com as mensagens",
      "mensagem enviada", "mensagens enviadas", "mensagem cancelada", "mensagens canceladas",
      "mensagem reagendada", "mensagens reagendadas", "mensagem reprogramada", "mensagens reprogramadas",
      "incluída em outra mensagem", "mensagem consolidada", "mensagens consolidadas", "consolidação",
      "verificação de disponibilidade", "mensagem de verificação", "mensagens de verificação", "próxima mensagem",
    ],
