...
const estadoExemplo = {
  ...
  config: { comissaoPercent: 50, agendaTipos: [], whatsappModelos: [], empresa: "", origensExtras: [] },
};
...
describe("useAppStore", () => {
  it("estado inicial espelha o STATE legado (vazio, comissaoPercent 100)", () => {
    ...
    expect(s.config).toEqual({ comissaoPercent: 100, agendaTipos: [], whatsappModelos: [], empresa: "", origensExtras: [] });
