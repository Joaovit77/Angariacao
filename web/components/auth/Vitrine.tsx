...
const CAMINHOS_ICONES: Record<Icone, React.ReactNode> = {
  ...
  whatsapp: <><path d="M20.5 11.7a8.45 8.45 0 0 1-12.3 7.5L3.5 20.5 4.8 16A8.45 8.45 0 1 1 20.5 11.7Z" /><path d="M9.15 8.2c.2-.4.6-.55.95-.35l1.15.65c.3.17.43.53.3.85l-.45 1.1c.65 1.05 1.35 1.75 2.4 2.4l1.1-.45c.32-.13.68 0 .85.3l.65 1.15c.2.35.05.75-.35.95-.75.37-1.65.45-2.45.18-2.05-.7-3.65-2.3-4.35-4.35-.27-.8-.19-1.7.18-2.45Z" /></>,
